...
for runPeriod in runPeriods:
    ...
    if background == "FAKE" or background == "ALL":
        ...
        for nLayersWord in nLayersWords:
            ...
            fout = TFile.Open("fakeTrackSystematic_zToMuMu_2022" + runPeriod + "_" + nLayersWord + ".root", "recreate")
            txtFile = "fakeTrackSystematic_zToMuMu_2022" + runPeriod + "_" + nLayersWord + '.txt'
            f = open(txtFile, 'w+')
            f.close()
            ...
            fout = TFile.Open("fakeTrackSystematic_zToEE_2022" + runPeriod + "_" + nLayersWord + ".root", "recreate")
            txtFile = "fakeTrackSystematic_zToEE_2022" + runPeriod + "_" + nLayersWord + '.txt'
            f = open(txtFile, 'w+')
            f.close()
            fakeTrackBkgdEstimate = FakeTrackBkgdEstimate ()
            fakeTrackBkgdEstimate.addTFile (fout)
