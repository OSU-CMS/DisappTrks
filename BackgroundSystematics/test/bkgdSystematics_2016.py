...
if background == "FAKE" or background == "ALL":
    ...
    nTracksReweightedFakeTrackSystematic.reweightDenominatorTo ("SingleMu_2016H", dirs['Andrew']+"2016_final_prompt/fakeTrackBackgroundTest", "ZtoMuMu", "Eventvariable Plots/nTracks")
    ...
    rhoReweightedFakeTrackSystematic.reweightDenominatorTo ("SingleMu_2016H", dirs['Andrew']+"2016_final_prompt/fakeTrackBackgroundTest", "ZtoMuMu", "Eventvariable Plots/trackRho")
