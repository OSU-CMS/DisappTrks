...
for runPeriod in runPeriods:
    ...
    if background == "FAKE" or background == "ALL":
        ...
        for nLayersWord in nLayersWords:
            ...
            fakeTrackBkgdEstimate.addChannel("Basic3hits",     "ZtoMuMuDisTrkNoD0CutNLayers4",       "SingleMu_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/fakeBackground") #used for transfer factor
    ...
    if background == "MUON" or background == "LEPTON" or background == "ALL":
        ...
        if combineLayers:
            ...
            muonBkgdEstimate.addChannel("TagProbe",       "ZtoMuProbeTrk"             + nLayersWords[0], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWords[0])
            muonBkgdEstimate.addChannel("TagProbePass",   "ZtoMuProbeTrkWithFilter"   + nLayersWords[0], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWords[0])
            muonBkgdEstimate.addChannel("TagProbePassSS", "ZtoMuProbeTrkWithSSFilter" + nLayersWords[0], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWords[0])
            muonBkgdEstimate.addChannel("TagPt35",        "MuonTagPt55"               + nLayersWords[0], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/muonControlRegion")
            muonBkgdEstimate.addChannel("TagPt35MetTrig", "MuonTagPt55MetTrig"        + nLayersWords[0], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/muonControlRegion")


            for iBin in range(1, len(nLayersWords)):
                muonBkgdEstimate.appendChannel("TagProbe",       "ZtoMuProbeTrk"             + nLayersWords[iBin], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWords[iBin])
                muonBkgdEstimate.appendChannel("TagProbePass",   "ZtoMuProbeTrkWithFilter"   + nLayersWords[iBin], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWords[iBin])
                muonBkgdEstimate.appendChannel("TagProbePassSS", "ZtoMuProbeTrkWithSSFilter" + nLayersWords[iBin], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWords[iBin])
                muonBkgdEstimate.appendChannel("TagPt35",        "MuonTagPt55"               + nLayersWords[iBin], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/muonControlRegion")
                muonBkgdEstimate.appendChannel("TagPt35MetTrig", "MuonTagPt55MetTrig"        + nLayersWords[iBin], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/muonControlRegion")
            ...
            if runPeriod in ['C', 'D', 'CD'] and applyHEMveto:
                ...
                muonBkgdEstimate.addChannel("TagPt35MetTrigHEMveto", "MuonTagPt55MetTrigHEMvetoNLayers6plus", "SingleMu_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/muonControlRegion_HEMveto_NLayers6plus")
        ...
        for nLayersWord in nLayersWords:
            ...
            muonBkgdEstimate.addChannel("TagProbe",       "ZtoMuProbeTrk"             + nLayersWord, "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWord)
            muonBkgdEstimate.addChannel("TagProbePass",   "ZtoMuProbeTrkWithFilter"   + nLayersWord, "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWord)
            muonBkgdEstimate.addChannel("TagProbePassSS", "ZtoMuProbeTrkWithSSFilter" + nLayersWord, "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/muonBackground_" + nLayersWord)
            muonBkgdEstimate.addChannel("TagPt35",        "MuonTagPt55"               + nLayersWord, "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/muonControlRegion")
            muonBkgdEstimate.addChannel("TagPt35MetTrig", "MuonTagPt55MetTrig"        + nLayersWord, "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/muonControlRegion")
    ...
    if background == "TAU" or background == "LEPTON" or background == "ALL":
        ...
        if combineLayers:
            ...
            tauBkgdEstimate.addChannel("TagProbe",         "ZtoTauToMuProbeTrk"              + nLayersWords[0], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePass",     "ZtoTauToMuProbeTrkWithFilter"    + nLayersWords[0], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePassSS",   "ZtoTauToMuProbeTrkWithSSFilter"  + nLayersWords[0], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
            tauBkgdEstimate.addChannel("TagProbe1",        "ZtoTauToEleProbeTrk"             + nLayersWords[0], "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePass1",    "ZtoTauToEleProbeTrkWithFilter"   + nLayersWords[0], "EGamma_rereco_2018"   + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePassSS1",  "ZtoTauToEleProbeTrkWithSSFilter" + nLayersWords[0], "EGamma_rereco_2018"   + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
            tauBkgdEstimate.addChannel("TagPt35",          "TauTagPt55"                      + nLayersWords[0], "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")
            tauBkgdEstimate.addChannel("TagPt35MetTrig",   "TauTagPt55MetTrig"               + nLayersWords[0], "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")
            tauBkgdEstimate.addChannel("TrigEffDenom",     "ElectronTagPt55"                 + nLayersWords[0], "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/electronControlRegionBinnedLayers")
            tauBkgdEstimate.addChannel("TrigEffNumer",     "ElectronTagPt55MetTrig"          + nLayersWords[0], "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/electronControlRegionBinnedLayers")
            tauBkgdEstimate.addChannel("TagPt35MetL1Trig", "TauTagPt55"                      + nLayersWords[0], "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")

            if runPeriod in ['C', 'D', 'CD'] and applyHEMveto:
                # HEM 15/16 issue; veto MET in phi range
                tauBkgdEstimate.addChannel("TrigEffNumerHEMveto", "ElectronTagPt55MetTrigHEMveto" + nLayersWords[0], "EGamma_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/electronControlRegion_HEMveto")

            for iBin in range(1, len(nLayersWords)):
                tauBkgdEstimate.appendChannel("TagProbe",         "ZtoTauToMuProbeTrk"              + nLayersWords[iBin], "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
                tauBkgdEstimate.appendChannel("TagProbePass",     "ZtoTauToMuProbeTrkWithFilter"    + nLayersWords[iBin], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
                tauBkgdEstimate.appendChannel("TagProbePassSS",   "ZtoTauToMuProbeTrkWithSSFilter"  + nLayersWords[iBin], "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
                tauBkgdEstimate.appendChannel("TagProbe1",        "ZtoTauToEleProbeTrk"             + nLayersWords[iBin], "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
                tauBkgdEstimate.appendChannel("TagProbePass1",    "ZtoTauToEleProbeTrkWithFilter"   + nLayersWords[iBin], "EGamma_rereco_2018"   + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
                tauBkgdEstimate.appendChannel("TagProbePassSS1",  "ZtoTauToEleProbeTrkWithSSFilter" + nLayersWords[iBin], "EGamma_rereco_2018"   + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
                tauBkgdEstimate.appendChannel("TagPt35",          "TauTagPt55"                      + nLayersWords[iBin], "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")
                tauBkgdEstimate.appendChannel("TagPt35MetTrig",   "TauTagPt55MetTrig"               + nLayersWords[iBin], "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")
                tauBkgdEstimate.appendChannel("TrigEffDenom",     "ElectronTagPt55"                 + nLayersWords[iBin], "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/electronControlRegionBinnedLayers")
                tauBkgdEstimate.appendChannel("TrigEffNumer",     "ElectronTagPt55MetTrig"          + nLayersWords[iBin], "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/electronControlRegionBinnedLayers")
                tauBkgdEstimate.appendChannel("TagPt35MetL1Trig", "TauTagPt55"                      + nLayersWords[iBin], "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")
 
                if runPeriod in ['C', 'D', 'CD'] and applyHEMveto:
                    # HEM 15/16 issue; veto MET in phi range
                    tauBkgdEstimate.appendChannel("TrigEffNumerHEMveto", "ElectronTagPt55MetTrigHEMveto" + nLayersWords[iBin], "EGamma_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/electronControlRegion_HEMveto")
        ...
        for nLayersWord in nLayersWords:
            ...
            tauBkgdEstimate.addChannel("TagProbe",         "ZtoTauToMuProbeTrk"              + nLayersWord, "SingleMu_2018"        + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePass",     "ZtoTauToMuProbeTrkWithFilter"    + nLayersWord, "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePassSS",   "ZtoTauToMuProbeTrkWithSSFilter"  + nLayersWord, "SingleMu_rereco_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/ZtoTauToMuProbeTrk")
            tauBkgdEstimate.addChannel("TagProbe1",        "ZtoTauToEleProbeTrk"             + nLayersWord, "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePass1",    "ZtoTauToEleProbeTrkWithFilter"   + nLayersWord, "EGamma_rereco_2018"   + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
            tauBkgdEstimate.addChannel("TagProbePassSS1",  "ZtoTauToEleProbeTrkWithSSFilter" + nLayersWord, "EGamma_rereco_2018"   + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/ZtoTauToEleProbeTrk")
            tauBkgdEstimate.addChannel("TagPt35",          "TauTagPt55"                      + nLayersWord, "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")
            tauBkgdEstimate.addChannel("TagPt35MetTrig",   "TauTagPt55MetTrig"               + nLayersWord, "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")
            tauBkgdEstimate.addChannel("TrigEffDenom",     "ElectronTagPt55"                 + nLayersWord, "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/electronControlRegionBinnedLayers")
            tauBkgdEstimate.addChannel("TrigEffNumer",     "ElectronTagPt55MetTrig"          + nLayersWord, "EGamma_2018"          + runPeriod, dirs['Mike']   + "kweiStore/2018/fromLPC/electronControlRegionBinnedLayers")
            tauBkgdEstimate.addChannel("TagPt35MetL1Trig", "TauTagPt55"                      + nLayersWord, "Tau_2018"             + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/TauControlRegion")

            if runPeriod in ['C', 'D', 'CD'] and applyHEMveto:
                # HEM 15/16 issue; veto MET in phi range
                tauBkgdEstimate.addChannel("TrigEffNumerHEMveto", "ElectronTagPt55MetTrigHEMveto" + nLayersWord, "EGamma_2018" + runPeriod, dirs['Mike'] + "bfrancisStore/2018/fromLPC/electronControlRegion_HEMveto")
