...
for runPeriod in runPeriods:
    ...
    if background == "FAKE" or background == "ALL":
        ...
        fakeTrackBkgdEstimate.addLuminosityInInvFb (lumi["MET_2016" + runPeriod] / 1000.)
    ...
    if background == "ELECTRON" or background == "ALL":
        ...
        electronBkgdEstimate.addLuminosityInInvFb (lumi["MET_2016" + runPeriod] / 1000.)
    ...
    if background == "MUON" or background == "ALL":
        ...
        muonBkgdEstimate.addLuminosityInInvFb (lumi["MET_2016" + runPeriod] / 1000.)
    ...
    if background == "TAU" or background == "ALL":
        ...
        tauBkgdEstimate.addLuminosityInInvFb (lumi["MET_2016" + runPeriod] / 1000.)
