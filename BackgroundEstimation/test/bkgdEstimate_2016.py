...
for runPeriod in runPeriods:
    ...
    if background == "ELECTRON" or background == "LEPTON" or background == "ALL":
        ...
        electronBkgdEstimate.addChannel  ("TagProbePassSS",  "ZtoEleProbeTrkWithSSFilter",  "SingleEle_2016"         +  runPeriod,  dirs['Andrew']+"2016_final_prompt/stenson/sameSign/skims/electronBackground")
    ...
    if background == "TAU" or background == "LEPTON" or background == "ALL":
        ...
        tauBkgdEstimate.addChannel  ("TagProbePassSS",   "ZtoTauToMuProbeTrkWithSSFilter",   "SingleMu_2016"          +  runPeriod,  dirs['Andrew']+"2016_final_prompt/stenson/sameSign/skims/tauToMuonBackground")
        ...
        tauBkgdEstimate.addChannel  ("TagProbePassSS1",  "ZtoTauToEleProbeTrkWithSSFilter",  "SingleEle_2016"         +  runPeriod,  dirs['Andrew']+"2016_final_prompt/stenson/sameSign/skims/tauToElectronBackground")
