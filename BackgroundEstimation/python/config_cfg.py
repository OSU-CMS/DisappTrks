...
#  add_channels  (process,  [ZtoEleProbeTrk],                   histSetsElectron,  weightsWithEleSF,  scaleFactorProducersWithElectrons,  collectionMap,  variableProducers + electronTPProducer,  False)
#  add_channels  (process,  [ZtoEleProbeTrkWithFilter],         histSetsElectron,  weightsWithEleSF,  scaleFactorProducersWithElectrons,  collectionMap,  variableProducers + electronTPProducer,  True)
#  add_channels  (process,  [ZtoEleSSProbeTrk],                 histSetsElectron,  weightsWithEleSF,  scaleFactorProducersWithElectrons,  collectionMap,  variableProducers + electronTPProducer,  False)
#  add_channels  (process,  [ZtoEleSSProbeTrkWithSSFilter],     histSetsElectron,  weightsWithEleSF,  scaleFactorProducersWithElectrons,  collectionMap,  variableProducers + electronTPProducer,  True)
...
#  add_channels  (process,  [ZtoTauToEleSSProbeTrk],                     histSetsElectron,  weightsWithEleSF,  scaleFactorProducersWithElectrons,  collectionMap,  variableProducers + tauToElectronTPProducer,  False)
#  add_channels  (process,  [ZtoTauToEleSSProbeTrkWithSSFilter],         histSetsElectron,  weightsWithEleSF,  scaleFactorProducersWithElectrons,  collectionMap,  variableProducers + tauToElectronTPProducer,  True)
...
#  add_channels  (process,  [ElectronTagPt55],         histSetsElectron,  weightsWithEleSF,  scaleFactorProducersWithElectrons,  collectionMap,  variableProducers + electronMETTriggerProducer,  False)
...
#  add_channels  (process,  [ZtoMuProbeTrk],                   histSetsMuon,  weightsWithMuonSF,  scaleFactorProducersWithMuons,  collectionMap,  variableProducers + muonTPProducer,  False)
#  add_channels  (process,  [ZtoMuProbeTrkWithFilter],         histSetsMuon,  weightsWithMuonSF,  scaleFactorProducersWithMuons,  collectionMap,  variableProducers + muonTPProducer,  True)
#  add_channels  (process,  [ZtoMuSSProbeTrk],                 histSetsMuon,  weightsWithMuonSF,  scaleFactorProducersWithMuons,  collectionMap,  variableProducers + muonTPProducer,  False)
#  add_channels  (process,  [ZtoMuSSProbeTrkWithSSFilter],     histSetsMuon,  weightsWithMuonSF,  scaleFactorProducersWithMuons,  collectionMap,  variableProducers + muonTPProducer,  True)
...
#  add_channels  (process,  [ZtoTauToMuSSProbeTrk],                     histSetsMuon,  weightsWithMuonSF,  scaleFactorProducersWithMuons,  collectionMap,  variableProducers + tauToMuonTPProducer,  False)
#  add_channels  (process,  [ZtoTauToMuSSProbeTrkWithSSFilter],         histSetsMuon,  weightsWithMuonSF,  scaleFactorProducersWithMuons,  collectionMap,  variableProducers + tauToMuonTPProducer,  True)
...
#  add_channels  (process,  [MuonTagPt55],         histSetsMuon,  weightsWithMuonSF,  scaleFactorProducersWithMuons,  collectionMap,  variableProducers + muonMETTriggerProducer,  False)
...
#  add_channels  (process,  [TauTagPt55],         histSetsTau,  weights,  scaleFactorProducers,  collectionMap,  variableProducers + tauMETTriggerProducer,  False)
