...
makeLimitPlots.py -e 2018_NLayers4 -l wino -c limits_2018_NLayers4_${SUFFIX} -o exp
makeLimitPlots.py -e 2018_NLayers5 -l wino -c limits_2018_NLayers5_${SUFFIX} -o exp
makeLimitPlots.py -e 2018_NLayers6plus -l wino -c limits_2018_NLayers6plus_${SUFFIX} -o exp
