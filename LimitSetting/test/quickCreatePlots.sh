...
makeLimitPlots.py -e all20156 -l wino -c limits_all20156_${SUFFIX} -o exp
...
makeLimitPlots.py -e 2018AB_NLayers4 -l wino -c limits_2018AB_NLayers4_${SUFFIX} -o exp
makeLimitPlots.py -e 2018AB_NLayers5 -l wino -c limits_2018AB_NLayers5_${SUFFIX} -o exp
makeLimitPlots.py -e 2018AB_NLayers6plus -l wino -c limits_2018AB_NLayers6plus_${SUFFIX} -o exp

makeLimitPlots.py -e 2018CD_NLayers4 -l wino -c limits_2018CD_NLayers4_${SUFFIX} -o exp
makeLimitPlots.py -e 2018CD_NLayers5 -l wino -c limits_2018CD_NLayers5_${SUFFIX} -o exp
makeLimitPlots.py -e 2018CD_NLayers6plus -l wino -c limits_2018CD_NLayers6plus_${SUFFIX} -o exp

makeLimitPlots.py -e 2017_all -l wino -c limits_2017_all_${SUFFIX} -o exp
makeLimitPlots.py -e 2018AB_all -l wino -c limits_2018AB_all_${SUFFIX} -o exp
makeLimitPlots.py -e 2018CD_all -l wino -c limits_2018CD_all_${SUFFIX} -o exp
makeLimitPlots.py -e 2018_all -l wino -c limits_2018_all_${SUFFIX} -o exp
makeLimitPlots.py -e all20178 -l wino -c limits_all20178_${SUFFIX} -o exp
