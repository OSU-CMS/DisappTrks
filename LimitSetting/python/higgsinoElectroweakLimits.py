...
if arguments.era in ["2017_NLayers4", "2017_NLayers5", "2017_NLayers6plus"]:
	...
	signal_condor_dir = dirs["Breno"] + '/SignalMC/Run3/2022preEE/signalAcceptance_higgsino_sigCentralLooseNoMissOut_v2/'
	...
	signal_condor_dir = dirs["Breno"] + '/SignalMC/Run3/2023/signalAcceptance_higgsino_sigCentralLooseNoMissOut_v2/'
	signal_suffix = signal_suffix_in_datacard = '130X'
	nLayersWord = arguments.era.split('_')[1]
	signal_channel = 'disTrkSelectionSmearedJets' + nLayersWord + 'Plotter/Met Plots'
	signal_channel_tree = 'disTrkSelectionSmearedJets' + nLayersWord + 'TreeMaker/Tree'
	...
	signal_condor_dir = dirs["Breno"] + '/SignalMC/Run3/2023BPix/signalAcceptance_higgsino_sigCentralLooseNoMissOut_v2/'
	signal_suffix = signal_suffix_in_datacard = '130X'
	nLayersWord = arguments.era.split('_')[1]
	signal_channel = 'disTrkSelectionSmearedJets' + nLayersWord + 'Plotter/Met Plots'
	signal_channel_tree = 'disTrkSelectionSmearedJets' + nLayersWord + 'TreeMaker/Tree'
...
if arguments.era in ["2022CD_NLayers4", "2022CD_NLayers5", "2022CD_NLayers6plus"]:
	external_systematic_uncertainties.append("higgsino_electronVetoScaleFactor_2022CD_" + arguments.era[7:])
	external_systematic_uncertainties.append("higgsino_muonVetoScaleFactor_2022CD_"     + arguments.era[7:])
	if arguments.era != "2022CD_NLayers6plus":
		external_systematic_uncertainties.append("higgsino_triggerTurnOn_2022CD_"       + arguments.era[7:])
...
if arguments.era in ["2023C_NLayers4", "2023C_NLayers5", "2023C_NLayers6plus"]:
	external_systematic_uncertainties.append("higgsino_electronVetoScaleFactor_2023C_" + arguments.era[6:])
	external_systematic_uncertainties.append("higgsino_muonVetoScaleFactor_2023C_"     + arguments.era[6:])
	if arguments.era != "2023C_NLayers6plus":
		external_systematic_uncertainties.append("higgsino_triggerTurnOn_2023C_"       + arguments.era[6:])

if arguments.era in ["2023D_NLayers4", "2023D_NLayers5", "2023D_NLayers6plus"]:
	external_systematic_uncertainties.append("higgsino_electronVetoScaleFactor_2023D_" + arguments.era[6:])
	external_systematic_uncertainties.append("higgsino_muonVetoScaleFactor_2023D_"     + arguments.era[6:])
	if arguments.era != "2023D_NLayers6plus":
		external_systematic_uncertainties.append("higgsino_triggerTurnOn_2023D_"       + arguments.era[6:])
