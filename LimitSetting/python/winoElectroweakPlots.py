...
convertCmToNs = True
outputName = "limit_plots_wino.root"
...
plotDefinitions = [
    ...
    {
        # this will be the name of the canvas in the output root file
        'title' : 'lifetimeNs_vs_mass_color_wino',
    ...
    {
        'title' : 'significance_vs_mass_color_wino',
