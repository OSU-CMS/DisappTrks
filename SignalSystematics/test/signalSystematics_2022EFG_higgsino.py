...
if systematic == "TRIGGER" or systematic == "ALL":
    ...
    for flux in ['Data', 'MC']:
        fout = open(os.environ["CMSSW_BASE"] + "/src/DisappTrks/SignalSystematics/dataTest/systematic_values__higgsino_trigger_grandOrWeight" + flux + '_2022_' + nLayersWord + ".txt", "w")
...
if systematic == "MUON_VETO_SCALE_FACTOR" or systematic == "ALL": # TODO: check this cut
    ...
    muonVetoSFSystematic.addChannel("Data",   "ZtoEleProbeTrkWithLooseFilter"   + nLayersWord, "hist_merged_EGamma_2022EFG_LepVeto", dirs['Breno'] + "BGData/Run3/2022/EGammaSigSyst")
