...
files = []
for i in range(650):
    if exists("/data/users/borzari/condor/SignalMC/Run3/2022/step4/100cm/700GeV/hist_"+str(i)+".root"): files.append("file:/data/users/borzari/condor/SignalMC/Run3/2022/step4/100cm/700GeV/hist_"+str(i)+".root")
...
process.myPath = cms.Path(process.genWeightsTable)
