...
if year == '2022':
    ...
    for file in dataFiles:
        ...
        metNoMuHists[file] = getHist(dataFiles[file],data_condor_dir,'ZtoMuMuISRStudyPlotter','Met Plots/metNoMu',False)
        if not writeFile: diMuonPtHists[file].Rebin(4)
    ...
    Canvas_diMuonPt.SetRightMargin( CMS_lumi.R/CMS_lumi.W )
    Canvas_diMuonPt.SetTopMargin( CMS_lumi.T/CMS_lumi.H )
    Canvas_diMuonPt.SetBottomMargin( CMS_lumi.B/CMS_lumi.H )
    ...
    Canvas_metNoMu.SetRightMargin( CMS_lumi.R/CMS_lumi.W )
    Canvas_metNoMu.SetTopMargin( CMS_lumi.T/CMS_lumi.H )
    Canvas_metNoMu.SetBottomMargin( CMS_lumi.B/CMS_lumi.H )
...
if year == '2023':
    ...
    WTopHist_diMuonPt.Add(diMuonPtHists['TQbartoLNu_2023'])
    WTopHist_diMuonPt.Add(diMuonPtHists['TbarQtoLNu_2023'])
    WTopHist_diMuonPt.Add(diMuonPtHists['TWminusto2L2Nu_2023'])
    ...
    # Just for plotting
    QCDHist_diMuonPt = diMuonPtHists['WToLNu_4Jets_2023'].Clone("diMuonQCD")
    QCDHist_diMuonPt.SetDirectory(0)
    QCDHist_diMuonPt.SetFillColor(colors['QCD2022EE'])
    QCDHist_diMuonPt.SetLineColor(1)

    ZTo2NuHist_diMuonPt = diMuonPtHists['WToLNu_4Jets_2023'].Clone("diMuonZTo2Nu")
    ZTo2NuHist_diMuonPt.SetDirectory(0)
    ZTo2NuHist_diMuonPt.SetFillColor(colors['ZJetsToNuNu2022EE'])
    ZTo2NuHist_diMuonPt.SetLineColor(1)
    ...
    DataHist_diMuonPt = diMuonPtHists['Muon_2023'].Clone("DataHist_diMuonPt")
    DataHist_diMuonPt.SetDirectory(0)
    ...
    CMS_lumi.CMS_lumi(Canvas_diMuonPt, iPeriod, iPos)
    Canvas_diMuonPt.Update()
    Canvas_diMuonPt.Print("isrWeights_2023.pdf")
    ...
    WTopHist_metNoMu.Add(metNoMuHists['TQbartoLNu_2023'])
    WTopHist_metNoMu.Add(metNoMuHists['TbarQtoLNu_2023'])
    WTopHist_metNoMu.Add(metNoMuHists['TWminusto2L2Nu_2023'])
    ...
    # Just for plotting
    QCDHist_metNoMu = metNoMuHists['WToLNu_4Jets_2023'].Clone("metNoMuQCD")
    QCDHist_metNoMu.SetDirectory(0)
    QCDHist_metNoMu.SetFillColor(colors['QCD2022EE'])
    QCDHist_metNoMu.SetLineColor(1)

    ZTo2NuHist_metNoMu = metNoMuHists['WToLNu_4Jets_2023'].Clone("metNoMuZTo2Nu")
    ZTo2NuHist_metNoMu.SetDirectory(0)
    ZTo2NuHist_metNoMu.SetFillColor(colors['ZJetsToNuNu2022EE'])
    ZTo2NuHist_metNoMu.SetLineColor(1)
    ...
    DataHist_metNoMu = metNoMuHists['Muon_2023'].Clone("DataHist_metNoMu")
    DataHist_metNoMu.SetDirectory(0)
    ...
    CMS_lumi.CMS_lumi(Canvas_metNoMu, iPeriod, iPos)
    Canvas_metNoMu.Update()
    Canvas_metNoMu.Print("beforeISRweights_metNoMu_2023.pdf")
