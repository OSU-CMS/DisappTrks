...
from amsbLimitConfigBkgds_2016 import *    # Produced with ../scripts/makeANTables.py
...
lumi = 6317.0
signalScaleFactor = 6317.0 / (2590.0 + 6317.0) # fraction of integrated luminosity from 2016
