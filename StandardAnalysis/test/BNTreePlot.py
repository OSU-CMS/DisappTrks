...
##     {  'channel'       : 'WToMuSimple',
##        'varToPlot'     : 'muons_tightID',
##        'histName'      : 'muons_tightID',
##        'nbins'         : 11,
##        'xMin'          : -0.5,
##        'xMax'          : 10.5,
##        'cutString'     : BNTreeWt, 
...
##       },
    ...
    { 'channel'       : 'WToMuSimple',
      'varToPlot'     : 'fabs(fabs(fabs(mets_phi - jets_phi[0]) - 3.14159) - 3.14159)', 
      'histName'      : 'deltaPhi_metVsJet',  
      'nbins'         : 100, 
      'xMin'          : -0.2, 
      'xMax'          :  3.17, 
      'cutString'     : '(@jets_pt.size() >= 1 ) * ' + BNTreeWt,  
...
##     { 'channel'       : 'WToMuSimple',
##       'varToPlot'     : 'fabs(fabs(fabs(mets_phi - muons_phi) - 3.14159) - 3.14159)', 
...
##     { 'channel'       : 'WToMuSimple',
##       'varToPlot'     : 'fabs(fabs(fabs(mets_phi - muons_phi) - 3.14159) - 3.14159)', 
##       'histName'      : 'deltaPhi_metsVsMuon_NJets0',  
##       'nbins'         : 100, 
##       'xMin'          : -0.2, 
##       'xMax'          :  3.17, 
##       'cutString'     : '(@jets_pt.size() == 0 ) * ' + BNTreeWt,
...
##     { 'channel'       : 'WToMuSimple',
##       'varToPlot'     : 'fabs(fabs(fabs(mets_phi - muons_phi) - 3.14159) - 3.14159)', 
##       'histName'      : 'deltaPhi_metsVsMuon_NJets1',  
##       'nbins'         : 100, 
##       'xMin'          : -0.2, 
##       'xMax'          :  3.17, 
##       'cutString'     : '(@jets_pt.size() == 1 ) * ' + BNTreeWt,
...
##     { 'channel'       : 'WToMuSimple',
##       'varToPlot'     : 'fabs(fabs(fabs(mets_phi - muons_phi) - 3.14159) - 3.14159)', 
##       'histName'      : 'deltaPhi_metsVsMuon_NJets2',  
##       'nbins'         : 100, 
##       'xMin'          : -0.2, 
##       'xMax'          :  3.17, 
...
##     { 'channel'       : 'WToMuSimple',
##       'varToPlot'     : 'fabs(fabs(fabs(mets_phi - muons_phi) - 3.14159) - 3.14159)', 
##       'histName'      : 'deltaPhi_metsVsMuon_NJets3',  
##       'nbins'         : 100, 
##       'xMin'          : -0.2, 
##       'xMax'          :  3.17, 
...
##       'xMin'          : 0,
##       'xMax'          : 500,
##       'cutString'     : '( muons_metMT > 50 ) * ' + BNTreeWt,  
##       },

##     { 'channel'       : 'WToMuSimple',
##       'varToPlot'     : 'mets_pt',
##       'histName'      : 'mets_pt_cutDeltaPhiMuonMet',
##       'nbins'         : 100,
##       'xMin'          : 0,
##       'xMax'          : 500,
##       'cutString'     : '( fabs(fabs(fabs(mets_phi - muons_phi) - 3.14159) - 3.14159) > 2.0 ) * ' + BNTreeWt,  
##       },

##     { 'channel'       : 'WToMuSimple',
##       'varToPlot'     : 'mets_pt',
##       'histName'      : 'mets_pt_cutEta',
##       'nbins'         : 100,
##       'xMin'          : 0,
##       'xMax'          : 500,
##       'cutString'     : '( fabs(muons_eta) < 2.1 ) * ' + BNTreeWt,  
##       },
 
    { 'channel'       : 'WToMuSimple',
      'varToPlot'     : 'mets_pt',
      'histName'      : 'mets_pt_metPhiLo',
      'nbins'         : 100,
      'xMin'          : 0,
      'xMax'          : 500,
      'cutString'     : '( fabs(mets_phi) < 1.0 ) * ' + BNTreeWt,  
      },

    { 'channel'       : 'WToMuSimple',
      'varToPlot'     : 'mets_pt',
      'histName'      : 'mets_pt_metPhiMed',
      'nbins'         : 100,
      'xMin'          : 0,
      'xMax'          : 500,
      'cutString'     : '( fabs(mets_phi) > 1.0 && fabs(mets_phi) < 2.0 ) * ' + BNTreeWt,  
      },

    { 'channel'       : 'WToMuSimple',
      'varToPlot'     : 'mets_pt',
      'histName'      : 'mets_pt_metPhiHi',
      'nbins'         : 100,
      'xMin'          : 0,
      'xMax'          : 500,
      'cutString'     : '( fabs(mets_phi) > 2.0 ) * ' + BNTreeWt,  
      },
...
##      { 'channel'       : 'WToMuSimple',
##        'varToPlot'     : 'mets_pt',
##        'histName'      : 'mets_pt_MuonChargePlus',
##        'nbins'         : 100,
##        'xMin'          : 0,
##        'xMax'          : 500,
##        'cutString'     : '( muons_charge  == 1 ) * ' + BNTreeWt,  
##        },

##      { 'channel'       : 'WToMuSimple',
##        'varToPlot'     : 'mets_pt',
##        'histName'      : 'mets_pt_MuonChargeMinus',
##        'nbins'         : 100,
##        'xMin'          : 0,
##        'xMax'          : 500,
##        'cutString'     : '( muons_charge  == -1 ) * ' + BNTreeWt,  
...
##      { 'channel'       : 'WToMuSimple',
##        'varToPlot'     : 'muons_phi',
##        'histName'      : 'muons_phi_isLooseHalo',
##        'nbins'         : 100,
##        'xMin'          : -3.15,
##        'xMax'          :  3.15,
...
##      { 'channel'       : 'WToMuSimple',
##        'varToPlot'     : 'muons_phi',
##        'histName'      : 'muons_phi_isNotLooseHalo',
##        'nbins'         : 100,
##        'xMin'          : -3.15,
##        'xMax'          :  3.15,
##        'cutString'     : '( events_CSCLooseHaloId == 0 ) * ' + BNTreeWt,  
...
##        },
     ...
     { 'channel'       : 'WToMuSimple',
       'varToPlot'     : 'mets_phi',
       'histName'      : 'mets_phi_cutNJet4',
       'nbins'         : 100,
       'xMin'          : -3.15,
       'xMax'          :  3.15,
       'cutString'     : '(@jets_pt.size() == 4 ) * ' + BNTreeWt,
       },

     { 'channel'       : 'WToMuSimple',
       'varToPlot'     : 'mets_phi',
       'histName'      : 'mets_phi_cutNJet5',
       'nbins'         : 100,
       'xMin'          : -3.15,
       'xMax'          :  3.15,
       'cutString'     : '(@jets_pt.size() >= 5 ) * ' + BNTreeWt,
       },
