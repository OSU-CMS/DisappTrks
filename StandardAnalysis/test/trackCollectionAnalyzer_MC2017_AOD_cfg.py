...
process.candidateTrackProducer.candMinPt = cms.double(0)
...
process.trackCollectionAna = cms.Path(process.trackCollectionAnalyzer)
...
process.MINIAODSIMoutput.outputCommands.append('drop *')
