...
tauBkgdEstimate.addChannel  ("TagProbePass",    "ZtoTauDisTrk",             "SingleMu_2015D_rereco",  dirs['Andrew']+"2015/tauBackground")
tauBkgdEstimate.addChannel  ("TagProbe1",        "ZtoTauToEleProbeTrkWithZCuts",  "SingleEle_2015D",  dirs['Andrew']+"2015/tauBackground")
tauBkgdEstimate.addChannel  ("TagProbePass1",    "ZtoTauToEleDisTrk",             "SingleEle_2015D",  dirs['Andrew']+"2015/tauBackground")
