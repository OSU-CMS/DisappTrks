...
tauBkgdEstimate.addPurityFactor ([0.61, 0.02])
...
tauBkgdEstimate.addChannel  ("TagProbe",        "ZtoTauProbeTrkWithZCuts",  "SingleMu_2015D",  dirs['Andrew']+"2015/tauBackground_betterPurity")
tauBkgdEstimate.addChannel  ("TagProbePass",    "ZtoTauDisTrk",             "SingleMu_2015D_rereco",  dirs['Andrew']+"2015/tauBackground_betterPurity")
