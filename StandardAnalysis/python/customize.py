...
def customize (process,
    ...
    for channel in getListOfChannels (process):
        ...
        if hasattr (process, "EventTauToElectronTPProducer"):
            ...
            getattr (process, "EventTauToElectronTPProducer").triggerCollectionName = cms.string (triggerFiltersElectron[0])
            getattr (process, "EventTauToElectronTPProducer").triggerFilterName = cms.string (triggerFiltersElectron[1])
