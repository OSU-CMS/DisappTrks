...
if os.environ["CMSSW_VERSION"].startswith ("CMSSW_10_2_"):
    if osusub.batchMode and (osusub.datasetLabel in types) and (types[osusub.datasetLabel] == "data") and (osusub.datasetLabel.endswith("_2018C") || osusub.datasetLabel.endswith("_2018D")):
