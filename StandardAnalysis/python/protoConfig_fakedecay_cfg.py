...
from DisappTrks.StandardAnalysis.FakeDecay_datasets import *
process.source = cms.Source ("PoolSource",
    bypassVersionCheck = cms.untracked.bool (True),
    skipBadFiles = cms.untracked.bool (True),
    fileNames = cms.untracked.vstring (fakedecay_datasets),
...
muonPGunProducer = ["EventMuonPGunProducer"]
...
from DisappTrks.BackgroundEstimation.MuonGunSelections import * # Unauthorized selection for chargino gun
...
if os.environ["CMSSW_VERSION"].startswith ("CMSSW_9_4_") and not UseCandidateTracks:
    ...
    from DisappTrks.StandardAnalysis.HistogramDefinitionsFakeDecay import *
    from DisappTrks.StandardAnalysis.BranchDefinitionsFakeDecay import *
...
############ histogram for particle gun #######
#histSetsGun = copy.deepcopy(histSets)
histSetsGun = cms.VPSet (
    TrackHistograms,
    FakeDecayHistograms,
)
