...
add_channels  (process,   [MuonGunSkim],                    histSetsGun,  lightweights,  [],  collMap,  variableProducers + muonPGunProducer, True)
#add_channels  (process,   [MuonGunSkim],                    histSetsGun,  weights,  [],  collMap,  variableProducers + muonPGunProducer, True)
#add_channels  (process,   [MuonGunSkim_Pt45to55],                    histSetsGun,  weights,  [],  collMap,  variableProducers + muonPGunProducer, True)
########################################################################
