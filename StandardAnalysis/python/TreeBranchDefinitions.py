...
if not UseCandidateTracks:
    ...
    TrackDebugBranches_names.extend([
        ...
        "matchedIsolatedTrack.pfIsolationDR03.chargedHadronIso",
        "matchedIsolatedTrack.pfIsolationDR03.neutralHadronIso",
        "matchedIsolatedTrack.pfIsolationDR03.photonIso",
        "matchedIsolatedTrack.pfIsolationDR03.puChargedHadronIso",
        "matchedIsolatedTrack.matchedCaloJetEmEnergy",
        "matchedIsolatedTrack.matchedCaloJetHadEnergy",
        "matchedIsolatedTrack.pfLepOverlap",
        "matchedIsolatedTrack.pfNeutralSum",
        "matchedIsolatedTrack.dz",
        "matchedIsolatedTrack.dxy",
        "matchedIsolatedTrack.dzError",
        "matchedIsolatedTrack.dxyError",
        "matchedIsolatedTrack.fromPV",
        "matchedIsolatedTrack.isHighPurityTrack",
        "matchedIsolatedTrack.isTightTrack",
        "matchedIsolatedTrack.isLooseTrack",
        "matchedIsolatedTrack.dEdxStrip",
        "matchedIsolatedTrack.dEdxPixel",
        "matchedIsolatedTrack.crossedEcalStatus",
        "matchedIsolatedTrack.crossHcalStatus",
        "matchedIsolatedTrack.deltaEta",
        "matchedIsolatedTrack.deltaPhi",        
    ])
