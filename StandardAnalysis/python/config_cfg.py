...
#  add_channels  (process,  [basicSelectionNoDijetPhiCut],   histSets,  weights,  [],  collectionMap,  variableProducers,  False)
#  add_channels  (process,  [basicSelectionNoJetMetPhiCut],  histSets,  weights,  [],  collectionMap,  variableProducers,  False)
...
#  add_channels  (process,  [isoTrkSelectionInvertDRJetCut],  histSets,      weights,  [],  collectionMap,  variableProducers,  True)
#  add_channels  (process,  [isoTrkSelectionBeforeIsoCut],    histSets,      weights,  [],  collectionMap,  variableProducers,  False)
