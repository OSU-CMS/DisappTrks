...
# with command line options: --python_filename JME-Run3Summer22EEMiniAODv3-00884_1_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:JME-Run3Summer22EEMiniAODv3-00884.root --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step PAT --nThreads 2 --geometry DB:Extended --filein file:JME-Run3Summer22EEDRPremix-00885.root --era Run3 --no_exec --mc -n 10000
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:TSG-Run3Summer22EEDR-00079.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JME-Run3Summer22EEMiniAODv3-00884.root'),
