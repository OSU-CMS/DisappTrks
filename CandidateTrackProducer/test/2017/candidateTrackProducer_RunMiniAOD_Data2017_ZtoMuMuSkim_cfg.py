...
process.MINIAODoutput.outputCommands.extend(
    cms.untracked.vstring(
        ...
        'keep *_reducedHcalRecHits_hbhereco_*',
...
process.zToMuMuFilterPath = cms.Path(process.zToMuMuFilter)
...
process.schedule = cms.Schedule(
    ...
    process.Flag_goodVertices,process.Flag_eeBadScFilter,
