...
config.Data.outputDatasetTag = 'RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-DisappTrks-v1' 
...
if __name__ == '__main__':
    ...
    config.General.requestName = 'candidateTrackProducer_WToLNu_HT-400to600_ext1'
    config.Data.inputDataset = '/WJetsToLNu_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2_ext1-v1/MINIAODSIM'
    #forkAndSubmit(config)
    ...
    config.General.requestName = 'candidateTrackProducer_WToLNu_HT-800to1200_ext1'
    config.Data.inputDataset = '/WJetsToLNu_HT-800To1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2_ext1-v1/MINIAODSIM'
    #forkAndSubmit(config)
    ...
    config.Data.inputDataset = '/WWTo2L2Nu_13TeV-powheg/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)
    ...
    config.Data.inputDataset = '/WZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)
    ...
    config.Data.inputDataset = '/ZZTo4L_13TeV_powheg_pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v2/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_ZZToNuNuQQ'
    config.Data.inputDataset = '/ZZTo2Q2Nu_13TeV_amcatnloFXFX_madspin_pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)
    ...
    config.Data.inputDataset = '/WGToLNuG_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_ZG'
    config.Data.inputDataset = '/ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_TTbarToLFromT'
    config.Data.inputDataset = '/TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_TTbarToLFromT_ext1'
    config.Data.inputDataset = '/TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2_ext1-v1/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_TTbarToLFromTbar'
    config.Data.inputDataset = '/TTJets_SingleLeptFromTbar_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_TTbarToLFromTbar_ext1'
    config.Data.inputDataset = '/TTJets_SingleLeptFromTbar_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2_ext1-v1/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_TTbarToLL'
    config.Data.inputDataset = '/TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM'
    #forkAndSubmit(config)

    config.General.requestName = 'candidateTrackProducer_TTbarToLL_ext1'
    ...
    config.Data.inputDataset = '/ST_t-channel_4f_leptonDecays_13TeV-amcatnlo-pythia8_TuneCUETP8M1/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2_ext1-v1/MINIAODSIM'
    #forkAndSubmit(config)
...
##########################################################################
    ...
    config.Data.outputDatasetTag = 'Run2015D-PromptReco-v3-DisappTrks-v1' 
    ...
    config.Data.outputDatasetTag = 'Run2015D-PromptReco-v4-DisappTrks-v1' 
