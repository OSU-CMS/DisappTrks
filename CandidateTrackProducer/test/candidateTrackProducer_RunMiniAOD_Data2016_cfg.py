...
# with command line options: PAT -s PAT --runUnscheduled --nThreads 4 --data --scenario pp --conditions 80X_dataRun2_Prompt_v8 --eventcontent MINIAOD --datatier MINIAOD --filein blah.root -n 100 --no_exec --python_filename=candidateTrackProducer_RunMiniAOD_Data_cfg.py --no_exec
