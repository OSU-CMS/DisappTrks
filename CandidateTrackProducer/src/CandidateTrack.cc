...
CandidateTrack::CandidateTrack (const reco::Track &track, const vector<reco::Track> &tracks, const vector<pat::Electron> &electrons, const vector<pat::Muon> &muons, const vector<pat::Tau> &taus, const reco::BeamSpot &beamspot, const vector<reco::Vertex> &vertices, const edm::Handle<vector<reco::Conversion> > &conversions) :
  ...
  deltaRToClosestVetoElectron_ (vertices.empty () ? INVALID_VALUE : getMinDeltaRToVetoElectron (electrons, beamspot, vertices.at (0), conversions)),
  deltaRToClosestLooseElectron_ (vertices.empty () ? INVALID_VALUE : getMinDeltaRToLooseElectron (electrons, beamspot, vertices.at (0), conversions)),
  deltaRToClosestMediumElectron_ (vertices.empty () ? INVALID_VALUE : getMinDeltaRToMediumElectron (electrons, beamspot, vertices.at (0), conversions)),
  deltaRToClosestTightElectron_ (vertices.empty () ? INVALID_VALUE : getMinDeltaRToTightElectron (electrons, beamspot, vertices.at (0), conversions)),
  ...
  deltaRToClosestTightMuon_     (vertices.empty () ? INVALID_VALUE : getMinDeltaRToTightMuon (muons, vertices.at (0))),
