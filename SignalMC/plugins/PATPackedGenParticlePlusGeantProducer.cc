...
namespace pat {
  class PATPackedGenParticlePlusGeantProducer : public edm::global::EDProducer<> {
  public:
...
pat::PATPackedGenParticlePlusGeantProducer::PATPackedGenParticlePlusGeantProducer(const edm::ParameterSet& iConfig) :
...
pat::PATPackedGenParticlePlusGeantProducer::~PATPackedGenParticlePlusGeantProducer() {}

void pat::PATPackedGenParticlePlusGeantProducer::produce(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const {
    ...
    std::unique_ptr<edm::Association< std::vector<pat::PackedGenParticle> > > gp2pgp(new edm::Association< std::vector<pat::PackedGenParticle> > (oh   ));
...
using pat::PATPackedGenParticlePlusGeantProducer;
#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(PATPackedGenParticlePlusGeantProducer);
