...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    particleFile = cms.untracked.string('DisappTrks/SignalMC/data/geant4_AMSB_chargino_800GeV_ctau10000cm.slha'),
    filterEfficiency = cms.untracked.double(1.0),
    pythiaHepMCVerbosity = cms.untracked.bool(False),
    processFile = cms.untracked.string('SimG4Core/CustomPhysics/data/RhadronProcessList.txt'),
    useregge = cms.bool(False),
    slhaFile = cms.untracked.string('DisappTrks/SignalMC/data/AMSB_chargino_800GeV_Isajet780.slha'),
    ...
    PythiaParameters = cms.PSet(
        ...
        parameterSets = cms.vstring('pythiaUESettings',
            'processParameters',
            'SLHAParameters'),
        SLHAParameters = cms.vstring('SLHAFILE = DisappTrks/SignalMC/data/AMSB_chargino_800GeV_Isajet780.slha')
    )
)
