...
config.JobType.psetName = 'step2/AMSB_chargino_step2_Run3_124X_cfg.py'
...
config.Data.outputDatasetTag = 'Run3Summer22DRPremixMiniAOD-124X_mcRun3_2021_realistic_v1-v1_step2'
