...
cmsDriver.py step1 \
--filein dbs:/AMSB_chargino_M-700_CTau-100_TuneCUEP8M1_13TeV_pythia8/bfrancis-RunIISummer17MiniAOD-92X_upgrade2017_realistic_v10-v1-51bf944d374d96f3ca6425a3ba05f7b2/USER \
--fileout file:AMSB_chargino700GeV_ctau100cm_step1.root \
--pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-MCv1_92X_upgrade2017_realistic_v8-v1/GEN-SIM-DIGI-RAW \
--mc \
--eventcontent PREMIXRAW \
--datatier GEN-SIM-RAW \
--conditions 92X_upgrade2017_realistic_v10 \
--step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:2e34_v2 \
--nThreads 4 \
--datamix PreMix \
--era Run2_2017 \
--python_filename digi_cfg.py \
--no_exec \
