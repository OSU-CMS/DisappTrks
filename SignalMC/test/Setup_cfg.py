...
for mass in masses:
  for lifetime in lifetimes:
    cff_file = "DisappTrks/SignalMC/python/pythia8Decay/AMSB_chargino"+str(mass)+"GeV_ctau"+str(lifetime)+"cm_NoFilter_13TeV.py"
    cmd = "cmsDriver.py  "
    cmd += cff_file
    ...
    cmd += " --python_filename step1/pythia8Decay/AMSB_chargino%dGeV_ctau%dcm_step1.py"%(mass,lifetime)
    cmd += " --no_exec -n 10"
    os.system(cmd)
