...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/AMSB_chargino500GeV_ctau100cm_NoFilter_8TeV.py nevts:5'),
