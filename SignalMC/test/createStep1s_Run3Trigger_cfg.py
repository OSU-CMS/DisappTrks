...
if os.environ['CMSSW_VERSION'] != 'CMSSW_11_2_2_patch1':
	print
	print 'Private generation of run3 trigger study samples must proceed in CMSSW_11_2_2_patch1, but you are in', os.environ['CMSSW_VERSION']
	print 'Quitting...'
	print
	sys.exit()
...
if scriptStep == 2:
	...
	cmd += ' --datatier GEN-SIM'
	cmd += ' --conditions 112X_mcRun3_2021_realistic_v15'
	...
	cmd += ' --beamspot Run3RoundOptics25ns13TeVLowSigmaZ'
	cmd += ' --step GEN,SIM'
	cmd += ' --nThreads 1 --geometry DB:Extended --era Run3'
