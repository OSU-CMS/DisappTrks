...
# with command line options: step2 --mc --eventcontent AODSIM --datatier AODSIM --conditions 124X_mcRun3_2022_realistic_v12 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --era Run3 --procModifiers siPixelQualityRawToDigi --filein file:AMSB_chargino_step2.root --fileout file:AMSB_chargino_step3.root --python_filename step3/AMSB_chargino_step3_2022_cfg.py --no_exec -n -1
