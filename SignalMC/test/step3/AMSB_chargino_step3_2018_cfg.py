...
# with command line options: step2 --filein file:AMSB_chargino700GeV_ctau100cm_step2.root --fileout file:AMSB_chargino700GeV_ctau100cm_step3.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,RECO,RECOSIM,EI --nThreads 4 --era Run2_2018 --python_filename step3/AMSB_chargino_step3_2018_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 10
