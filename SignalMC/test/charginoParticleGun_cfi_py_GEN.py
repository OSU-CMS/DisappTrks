...
# with command line options: DisappTrks/SignalMC/python/charginoParticleGun_cfi.py -s GEN --conditions auto:mc --mc -n 5 --no_exec --fileout charginoPartGun_GEN.root
#
# Use options specified on https://twiki.cern.ch/twiki/bin/viewauth/CMS/SWGuideCMSDataAnalysisSchool2015GeneratorExerciseatFNAL#Using_GeneratorInterface  
