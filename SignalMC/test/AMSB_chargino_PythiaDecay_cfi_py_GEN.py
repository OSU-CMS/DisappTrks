...
# with command line options: DisappTrks/SignalMC/python/AMSB_charginoXXXGeV_YYYctau_8TeV_pythia6_TestPythiaDecay_cfi.py -s GEN --conditions START53_V27::All --beamspot Realistic8TeVCollision --datatier GEN-SIM-RECO --datamix NODATAMIXER --eventcontent RAWSIM -n 5 --no_exec --fileout AMSB_chargino_GEN.root
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('AMSB_chargino_GEN.root'),
