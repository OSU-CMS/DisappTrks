...
# with command line options: DisappTrks/SignalMC/python/amsb_mGravXXX_YYYns_cfi.py -s GEN --conditions START53_V27::All --beamspot Realistic8TeVCollision --datatier GEN --eventcontent RAWSIM -n 100 --no_exec --fileout chargino_amsb_GEN.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/amsb_mGravXXX_YYYns_cfi.py nevts:100'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    particleFile = cms.untracked.string('DisappTrks/SignalMC/data/geant4_chargino_amsbLL01_mGrav100K_5ns-test.slha'), 
