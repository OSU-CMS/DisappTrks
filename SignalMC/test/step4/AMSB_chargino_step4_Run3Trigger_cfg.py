...
# with command line options: step4 --filein file:AMSB_chargino700GeV_ctau100cm_step3.root --fileout file:AMSB_chargino700GeV_ctau100cm_step4.root --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 112X_mcRun3_2021_realistic_v16 --step PAT --nThreads 4 --era Run3 --python_filename step4/AMSB_chargino_step4_Run3Trigger_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 10
