...
config.JobType.psetName = 'step2/AMSB_chargino_step2_Run3Trigger_cfg.py'
...
config.Data.outputDatasetTag = 'Run3Winter21DRMiniAOD-FlatPU20to70_112X_mcRun3_2021_realistic_v16'
    ...
    if reallySubmitHiggsinoEWK:
        for mass in range(100, 1000, 100):
            for ctau in [1, 10, 100, 1000, 10000]:
                ...
                config.Data.inputDataset = step1.higgsino2018[(mass, ctau)]
                if reallySubmitMass[mass] and reallySubmitLifetime[ctau]:
                    forkAndSubmit(config)
                else:
                    print 'Skipping submission of request:', config.General.requestName
