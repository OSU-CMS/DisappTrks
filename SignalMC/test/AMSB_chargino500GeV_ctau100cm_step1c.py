...
# with command line options: step1 --filein file:AMSB_chargino500GeV_ctau100cm_step1b.root --fileout file:AMSB_chargino500GeV_ctau100cm_step1c.root --mc --eventcontent RAWSIM --pileup AVE_20_BX_25ns --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --conditions MCRUN2_71_V1::All --step HLT:GRun --magField 38T_PostLS1 --python_filename AMSB_chargino500GeV_ctau100cm_step1c.py --no_exec -n 5
...
# Do only --step HLG:Grun, the step that uses the most memory.   
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:AMSB_chargino500GeV_ctau100cm_step1b.root')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:AMSB_chargino500GeV_ctau100cm_step1c.root'),
