...
config.JobType.psetName = 'MC_step2_2018_cfg.py'  # For MC only
...
if __name__ == '__main__':
    ...
    #RERUN WJets
    config.Data.outputDatasetTag = '102X_upgrade2018_realistic_v15_v2'
    config.Data.unitsPerJob  =  3
    config.Data.totalUnits   =  24 

    config.JobType.psetName     = 'MC_step2_2018_cfg.py'
    config.General.requestName  = 'reprocess_WJets_102X_upgrade2018_realistic_v15_12June2020'
    config.Data.inputDataset    = '/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIFall18wmLHEGS-102X_upgrade2018_realistic_v11-v2/GEN-SIM'
