...
config.Data.outputDatasetTag = 'RunIIAutumn18DRPremix-102X_upgrade2018_realistic_v15-DisappTrks-v2'
...
if __name__ == '__main__':
    ...
    config.Data.outputDatasetTag = 'Run2018A-102X_dataRun2_v12-v3-MINIAOD'
    config.Data.unitsPerJob  =  3
    config.Data.inputDBS  =  "phys03"

    config.JobType.psetName     = 'DATA_step4_2018_cfg.py'
    config.General.requestName  = 'reprocess_SingleMu_Run2018A-23Jun2020v1'
    config.Data.inputDataset    = '/SingleMuon/kwei-Run2018A-102X_dataRun2_v12-v3-ee816b3a6d6faf0f6e88003e64bf3b96/USER'
