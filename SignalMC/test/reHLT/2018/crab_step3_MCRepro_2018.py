...
config.JobType.psetName = 'MC_step3_2018_cfg.py'  # For MC only
...
if __name__ == '__main__':
    ...
    #RERUN WJets
    config.Data.outputDatasetTag = '102X_upgrade2018_realistic_v15'
    config.Data.unitsPerJob  =  3
    config.Data.totalUnits   =  24 
    config.Data.inputDBS     =  "phys03"

    config.JobType.psetName     = 'MC_step3_2018_cfg.py'
    config.General.requestName  = 'reprocess_step3_WJets_102X_upgrade2018_realistic_v15_8June2020'
    config.Data.inputDataset    = '/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/kwei-102X_upgrade2018_realistic_v15-68215eac374f8467a5166c0f1af002e0/USER'
