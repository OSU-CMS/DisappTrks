...
# with command line options: DisappTrks/SignalMC/python/TestPythiaDecay_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:7E33v2,RAW2DIGI,L1Reco,RECO --conditions START53_V27::All --beamspot Realistic8TeVCollision --datatier GEN-SIM-RECO --datamix NODATAMIXER --eventcontent RECOSIM -n 3 --no_exec --fileout TestPythiaDecay_RECO.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/TestPythiaDecay_cfi.py nevts:3'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TestPythiaDecay_RECO.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        pythiaUESettings = cms.vstring('MSTU(21)=1     ! Check on possible errors during program execution', 
            ...
            'PARJ(71)=10000 .  ! for which ctau in mm', 
