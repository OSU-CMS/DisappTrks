...
# with command line options: DisappTrks/SignalMC/python/AMSB_chargino300GeV_ctau100cm_NoFilter_13TeV.py --fileout file:AMSB_chargino300GeV_ctau100cm_step1.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,DisappTrks/SignalMC/genParticlePlusGeant.customizeProduce,DisappTrks/SignalMC/genParticlePlusGeant.customizeKeep --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --python_filename AMSB_chargino300GeV_ctau100cm_step1.py --no_exec -n 46
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/AMSB_chargino300GeV_ctau100cm_NoFilter_13TeV.py nevts:46'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    particleFile = cms.untracked.string('DisappTrks/SignalMC/data/geant4/geant4_AMSB_chargino_300GeV_ctau100cm.slha'),
