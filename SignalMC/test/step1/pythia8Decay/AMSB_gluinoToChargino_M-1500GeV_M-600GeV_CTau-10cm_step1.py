...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/pythia8Decay/AMSB_gluinoToChargino_M-1500GeV_M-600GeV_CTau-10cm_TuneCP5_13TeV_pythia8_cff.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:AMSB_gluinoToChargino_M-1500GeV_M-600GeV_CTau-10cm_step1.root'),
