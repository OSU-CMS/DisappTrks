...
# with command line options: DisappTrks/SignalMC/python/pythia8Decay/AMSB_chargino300GeV_ctau1000cm_NoFilter_13TeV.py --fileout file:AMSB_chargino300GeV_ctau1000cm_step1.root --mc --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,SimG4Core/Application/customiseSequentialSim.customiseSequentialSim --datatier GEN-SIM --conditions 94X_mc2017_realistic_v10 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename step1/pythia8Decay/AMSB_chargino300GeV_ctau1000cm_step1.py --no_exec -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/pythia8Decay/AMSB_chargino300GeV_ctau1000cm_NoFilter_13TeV.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    particleFile = cms.untracked.string('DisappTrks/SignalMC/data/geant4_add100MeV/geant4_AMSB_chargino_300GeV_ctau1000cm.slha'),
