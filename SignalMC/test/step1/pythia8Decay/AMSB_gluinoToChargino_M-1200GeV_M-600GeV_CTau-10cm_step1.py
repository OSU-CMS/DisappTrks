...
# with command line options: DisappTrks/SignalMC/python/pythia8Decay/AMSB_gluinoToChargino_M-1200GeV_M-600GeV_CTau-10cm_TuneCP5_13TeV_pythia8_cff.py --fileout file:AMSB_gluinoToChargino_M-1200GeV_M-600GeV_CTau-10cm_step1.root --mc --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,SimG4Core/Application/customiseSequentialSim.customiseSequentialSim --datatier GEN-SIM --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename step1/pythia8Decay/AMSB_gluinoToChargino_M-1200GeV_M-600GeV_CTau-10cm_step1.py --no_exec -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/pythia8Decay/AMSB_gluinoToChargino_M-1200GeV_M-600GeV_CTau-10cm_TuneCP5_13TeV_pythia8_cff.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:AMSB_gluinoToChargino_M-1200GeV_M-600GeV_CTau-10cm_step1.root'),
