...
# with command line options: DisappTrks/SignalMC/python/higgsino/Higgsino_M-100GeV_CTau-10000cm_TuneCP5_13TeV_pythia8_cff.py --fileout file:Higgsino100GeV_ctau10000cm_step1.root --mc --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,SimG4Core/Application/customiseSequentialSim.customiseSequentialSim --datatier GEN-SIM --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename step1/higgsino/Higgsino100GeV_ctau10000cm_step1.py --no_exec -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/higgsino/Higgsino_M-100GeV_CTau-10000cm_TuneCP5_13TeV_pythia8_cff.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Higgsino100GeV_ctau10000cm_step1.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    crossSection = cms.untracked.double(13.53557),
    filterEfficiency = cms.untracked.double(-1),
    hscpFlavor = cms.untracked.string('stau'),
    massPoint = cms.untracked.int32(100),
    maxEventsToPrint = cms.untracked.int32(0),
    particleFile = cms.untracked.string('DisappTrks/SignalMC/data/geant4_higgsino/geant4_higgsino_100GeV_ctau10000cm.slha'),
