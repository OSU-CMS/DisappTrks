...
# with command line options: DisappTrks/SignalMC/python/pythia8/Hadronizer_TuneCP5_13TeV_generic_LHE_pythia8_cff.py --filein file:unweighted_events.lhe --fileout file:FIMP_M125GeV_ctau10cm_dm0p1_step1.root --mc --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,SimG4Core/Application/customiseSequentialSim.customiseSequentialSim --datatier LHE-GEN-SIM --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename step1/pythia8/FIMP_M125GeV_ctau10cm_dm0p1_step1.py --no_exec -n 100
...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('file:unweighted_events_M125GeV_ctau10cm_dm0p1_diffPID.lhe'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:FIMP_M125GeV_ctau10cm_dm0p1_pythiadef_diffPID_step1.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    SLHATableForPythia8 = cms.string('/n######################################################################/n## PARAM_CARD AUTOMATICALY GENERATED BY MG5 FOLLOWING UFO MODEL   ####/n######################################################################/n##                                                                  ##/n##  Width set on Auto will be computed following the information    ##/n##        present in the decay.py files of the model.               ##/n##        See  arXiv:1402.1178 for more details.                    ##/n##                                                                  ##/n######################################################################/n###################################/n## INFORMATION FOR CKMBLOCK/n###################################/nBlock ckmblock /n    1 2.277360e-01 # cabi /n###################################/n## INFORMATION FOR FRBLOCK/n###################################/nBlock frblock /n    1 1.000000e+02 # QS /n    2 2.000000e-05 # yHEeR /n    3 2.000000e-05 # yHEmuR /n    4 2.000000e-05 # yHEtaR /n    5 2.000000e-02 # lams0h /n    6 1.000000e-01 # lams0 /n###################################/n## INFORMATION FOR MASS/n###################################/nBlock mass /n    1 5.040000e-03 # MD /n    2 2.550000e-03 # MU /n    3 1.010000e-01 # MS /n    4 1.270000e+00 # MC /n    5 4.700000e+00 # MB /n    6 1.720000e+02 # MT /n   11 5.110000e-04 # Me /n   13 1.056600e-01 # MMU /n   15 1.777000e+00 # MTA /n   23 9.118760e+01 # MZ /n   25 1.250000e+02 # mh /n  255 1.250000e+02 # ms0 /n  1000101 1.251000e+02 # mHE /n## Dependent parameters, given by model restrictions./n## Those values should be edited following the /n## analytical expression. MG5 ignores those values /n## but they are important for interfacing the output of MG5/n## to external program such as Pythia./n  12 0.000000e+00 # ve : 0.0 /n  14 0.000000e+00 # vm : 0.0 /n  16 0.000000e+00 # vt : 0.0 /n  21 0.000000e+00 # g : 0.0 /n  22 0.000000e+00 # a : 0.0 /n  24 7.982436e+01 # w+ : cmath.sqrt(MZ__exp__2/2. + cmath.sqrt(MZ__exp__4/4. - (aEW*cmath.pi*MZ__exp__2)/(Gf*sqrt__2))) /n -1000101 1.251000e+02 # x1- : mHE /n###################################/n## INFORMATION FOR SMINPUTS/n###################################/nBlock sminputs /n    1 1.279000e+02 # aEWM1 /n    2 1.166370e-05 # Gf /n    3 1.184000e-01 # aS /n###################################/n## INFORMATION FOR YUKAWA/n###################################/nBlock yukawa /n    1 5.040000e-03 # ymdo /n    2 2.550000e-03 # ymup /n    3 1.010000e-01 # yms /n    4 1.270000e+00 # ymc /n    5 4.700000e+00 # ymb /n    6 1.720000e+02 # ymt /n   11 5.110000e-04 # yme /n   13 1.056600e-01 # ymm /n   15 1.777000e+00 # ymtau /n###################################/n## INFORMATION FOR DECAY/n###################################/nDECAY   6 1.508336e+00 # WT /nDECAY  23 2.495200e+00 # WZ /nDECAY  24 2.085000e+00 # WW /nDECAY  25 5.000000e-03 # wh /nDECAY 255 0.000000e+00 # ws0 /nDECAY 1000101 2.000000e-15 # wHE /n## Dependent parameters, given by model restrictions./n## Those values should be edited following the /n## analytical expression. MG5 ignores those values /n## but they are important for interfacing the output of MG5/n## to external program such as Pythia./nDECAY  1 0.000000e+00 # d : 0.0 /nDECAY  2 0.000000e+00 # u : 0.0 /nDECAY  3 0.000000e+00 # s : 0.0 /nDECAY  4 0.000000e+00 # c : 0.0 /nDECAY  5 0.000000e+00 # b : 0.0 /nDECAY  11 0.000000e+00 # e- : 0.0 /nDECAY  12 0.000000e+00 # ve : 0.0 /nDECAY  13 0.000000e+00 # mu- : 0.0 /nDECAY  14 0.000000e+00 # vm : 0.0 /nDECAY  15 0.000000e+00 # ta- : 0.0 /nDECAY  16 0.000000e+00 # vt : 0.0 /nDECAY  21 0.000000e+00 # g : 0.0 /nDECAY  22 0.000000e+00 # a : 0.0 /nDECAY  -1000101 2.000000e-15 # x1- : wHE /n#===========================================================/n# QUANTUM NUMBERS OF NEW STATE(S) (NON SM PDG CODE)/n#===========================================================/nBlock QNUMBERS 255  # n1 /n        1 0  # 3 times electric charge/n        2 1  # number of spin states (2S+1)/n        3 1  # colour rep (1: singlet, 3: triplet, 8: octet)/n        4 0  # Particle/Antiparticle distinction (0=own anti)/nBlock QNUMBERS 1000101  # n1 /n        1 3  # 3 times electric charge/n        2 2  # number of spin states (2S+1)/n        3 1  # colour rep (1: singlet, 3: triplet, 8: octet)/n        4 1  # Particle/Antiparticle distinction (0=own anti)/nBlock QNUMBERS -1000101  # n1 /n        1 -3  # 3 times electric charge/n        2 2  # number of spin states (2S+1)/n        3 1  # colour rep (1: singlet, 3: triplet, 8: octet)/n        4 1  # Particle/Antiparticle distinction (0=own anti)'),
