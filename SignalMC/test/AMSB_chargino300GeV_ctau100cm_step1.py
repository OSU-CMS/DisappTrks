...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/AMSB_chargino300GeV_ctau100cm_NoFilter_13TeV.py nevts:5'),
