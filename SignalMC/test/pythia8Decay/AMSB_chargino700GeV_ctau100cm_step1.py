...
# with command line options: DisappTrks/SignalMC/python/pythia8Decay/AMSB_chargino700GeV_ctau100cm_NoFilter_13TeV_cff.py --fileout file:AMSB_chargino700GeV_ctau100cm_step1.root --mc --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,SimG4Core/Application/customiseSequentialSim.customiseSequentialSim --datatier GEN-SIM --conditions 92X_upgrade2017_realistic_v10 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --magField 38T_PostLS1 --python_filename pythia8Decay/AMSB_chargino700GeV_ctau100cm_step1.py --geometry DB:Extended --era Run2_2017 --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('DisappTrks/SignalMC/python/pythia8Decay/AMSB_chargino700GeV_ctau100cm_NoFilter_13TeV_cff.py nevts:100'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    particleFile = cms.untracked.string('DisappTrks/SignalMC/data/geant4_AMSBchargino_700GeV_nodecay.slha'),
