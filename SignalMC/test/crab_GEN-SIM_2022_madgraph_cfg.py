...
config.Data.outputDatasetTag = 'Run3Summer22DRPremixMiniAOD-124X_mcRun3_2022_realistic_v12-v1'
    ...
    if reallySubmitEWK:
      for mass in range(100, 2100, 100):
          for ctau in [1, 10, 100, 1000, 10000]:
              ...
              config.JobType.psetName = 'step1/pythia8/AMSB_chargino_M%dGeV_CTau%dcm_TuneCP5_PSweights_13p6TeV_madgraph5_pythia8_step1.py' % (mass, ctau)
              config.Data.outputPrimaryDataset = 'AMSB_chargino_M-%dGeV_CTau-%dcm_TuneCP5_PSweights_13p6TeV_madgraph5_pythia8' % (mass, ctau)
