...
# with command line options: Configuration/Generator/python/amsb_mGrav125K_5ns_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:7E33v2,RAW2DIGI,L1Reco,RECO --conditions START53_V27::All --beamspot Realistic8TeVCollision --datatier GEN-SIM-RECO --pileup 2012_Summer_50ns_PoissonOOTPU --datamix NODATAMIXER --eventcontent RECOSIM -n 5 --no_exec --fileout chargino_amsb_mGrav125K_5ns_RECO.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/python/amsb_mGrav125K_5ns_cfi.py nevts:5'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    particleFile = cms.untracked.string('Configuration/Generator/data/geant4_chargino_amsbLL01_mGrav125K_5ns.slha'),
