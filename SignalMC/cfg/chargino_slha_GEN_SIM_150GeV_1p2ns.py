...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #    fileName = cms.untracked.string('chargino_150GeV_1p2ns_slha_GEN_SIM.root'),
...
#	    'KFDP(2595,5)= 0        ! same as above',
    ...
    particleFile = cms.untracked.string('Configuration/Generator/data/geant4_chargino_150GeV_1p2ns.slha'),
