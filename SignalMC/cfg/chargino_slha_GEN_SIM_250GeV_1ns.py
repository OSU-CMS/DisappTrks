...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #    fileName = cms.untracked.string('chargino_250GeV_1ns_slha_GEN_SIM.root'),
...
#	    'KFDP(2595,5)= 0        ! same as above',
        ...
        SLHAParameters = cms.vstring(
          'SLHAFILE = Configuration/Generator/data/pythia6_chargino_250GeV_1ns.slha'
        ),
        parameterSets = cms.vstring('pythiaUESettings', 'processParameters', 'SLHAParameters')
    ),
    hscpFlavor = cms.untracked.string('stau'),
    massPoint = cms.untracked.int32(250),
    slhaFile = cms.untracked.string('Configuration/Generator/data/pythia6_chargino_250GeV.slha'),
    processFile = cms.untracked.string('SimG4Core/CustomPhysics/data/RhadronProcessList.txt'),
    particleFile = cms.untracked.string('Configuration/Generator/data/geant4_chargino_250GeV_1ns.slha'),
