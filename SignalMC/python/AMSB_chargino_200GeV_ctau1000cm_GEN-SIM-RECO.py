...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    slhaFile = cms.untracked.string('DisappTrks/SignalMC/data/AMSB_chargino_200GeV.slha'),
    ...
    PythiaParameters = cms.PSet(
        ...
        parameterSets = cms.vstring('pythiaUESettings', 
            'processParameters', 
            'SLHAParameters'),
        SLHAParameters = cms.vstring('SLHAFILE = DisappTrks/SignalMC/data/AMSB_chargino_200GeV.slha')
    )
)
