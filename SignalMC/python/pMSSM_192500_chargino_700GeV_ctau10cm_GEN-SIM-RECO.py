...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    particleFile = cms.untracked.string('DisappTrks/SignalMC/data/pMSSM_192500_chargino700GeV_ctau10cm_geant4.slha'), 
    filterEfficiency = cms.untracked.double(1.0),
    pythiaHepMCVerbosity = cms.untracked.bool(False),
    processFile = cms.untracked.string('SimG4Core/CustomPhysics/data/RhadronProcessList.txt'),
    useregge = cms.bool(False),
    slhaFile = cms.untracked.string('DisappTrks/SignalMC/data/pMSSM_192500_chargino700GeV_ctau10cm_noChiDecay.slha'), 
    ...
    PythiaParameters = cms.PSet(
        ...
        parameterSets = cms.vstring('pythiaUESettings', 
            'processParameters', 
            'SLHAParameters'),
        SLHAParameters = cms.vstring('SLHAFILE = DisappTrks/SignalMC/data/pMSSM_192500_chargino700GeV_ctau10cm_noChiDecay.slha') 
    )
)
